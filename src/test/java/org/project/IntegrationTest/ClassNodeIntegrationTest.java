...
//        assertEquals("color", retrievedNode.getFields().get(0).getName(), "Field name should be 'color'");
//    }
//
//    @Test
...
//        assertEquals("drive", retrievedNode.getMethods().get(0).getName(), "Method name should be 'drive'");
//    }
//
//    @Test
//    void testRelationshipExists() {
//        UMLClassNode retrievedNode = storage.getNode("Car");
//        assertEquals(1, retrievedNode.getRelationships().size(), "Class should have exactly one relationship");
//        assertEquals("Wheel", retrievedNode.getRelationships().get(0).getTarget(), "Relationship target should be 'Wheel'");
//    }
}
