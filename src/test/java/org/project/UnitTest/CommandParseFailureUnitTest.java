...
public class CommandParseFailureUnitTest {
  ...
  void testRenameFieldPrompt() {
    ...
    assertTrue(
        result
            .getMessage()
            .contains("rename field <existing field name> <new field name> <newType>"),
        "Error message should indicate duplicate class.");
  }
  ...
  void testRemoveMethodPrompt() {
    ...
    assertTrue(
        result
            .getMessage()
            .contains("remove method <method name> [<parameter type> <parameter name>...]"),
        "Error message should indicate duplicate class.");
  }
  ...
  void testRenameMethodPrompt() {
    ...
    assertTrue(
        result
            .getMessage()
            .contains("rename method <existing method name> <new method name> <return type>"),
        "Error message should indicate duplicate class.");
  }
