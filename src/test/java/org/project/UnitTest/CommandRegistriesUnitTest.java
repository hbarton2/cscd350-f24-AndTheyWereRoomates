...
//    CommandResult result = commandRegistries.executeCommand("create class", args); // Duplicate creation
...
//  }
  ...
  void testRenameClassCommandSuccess() {
    ...
    commandRegistries.executeCommand("create class",
      new String[]{"OldClass"}); // Create initial class
...
//  }
  ...
  void testAddFieldCommandSuccess() {
    ...
    commandRegistries.executeCommand("create class",
      new String[]{"MyClass"}); // Create initial class
...
//    String[] args = {"int", "fieldName"};
//    CommandResult result = commandRegistries.executeCommand("add field", args); // Without switching to a class
