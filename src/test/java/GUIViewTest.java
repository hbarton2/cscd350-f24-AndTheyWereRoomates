...
import org.project.Controller.GUIViewController;
...
/*
    ...
    public void testCreateClassSuccessfully() {
        // Setup mock behavior
        when(umlController.getStorage().hasClass(anyString())).thenReturn(false);  // Simulate no existing class
        ...
        String[] inspectorValues = {"TestClass", "testField", "String", "testMethod", "param1", "String"};
    ...
    void testCreateClassWithExistingName() {
        ...
        verify(yourController).showAlert(eq("Class Creation Error"), eq("A class with the name \"TestClass\" already exists."));
    }
    */
}
