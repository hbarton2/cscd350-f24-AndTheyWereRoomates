 ...
 *
 * <p>This arrow style is commonly used to indicate a composition relationship between two classes.
 * The arrowhead is represented as a filled diamond shape.
 */
public class CompositionArrow implements ArrowStrategy {
  /**
   * Draws a composition arrow.
   *
   * <p>The arrow consists of a diamond-shaped arrowhead, filled with red color, and a white line
   * representing the shaft of the arrow.
   *
