...
/**
 * Adapter that bridges {@code CommandLogic} and {@code CommandBridge}.
 * Delegates command execution to {@code CommandRegistries}.
 */
public class CommandBridgeAdapter implements CommandBridge {
   ...
   * @throws IllegalArgumentException if {@code commandLogic} is not a {@code CommandRegistries} instance
   */
