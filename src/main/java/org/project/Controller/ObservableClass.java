 ...
 *
 * <p>The {@code ObservableClass} class implements the observer design pattern, allowing observers
 * to register and be notified whenever there are changes to the selected graphical class node or
 * the list of class nodes.
 */
public class ObservableClass {
  ...
  /**
   * Notifies all registered observers of changes to the selected class box or the list of class
   * nodes.
   */
