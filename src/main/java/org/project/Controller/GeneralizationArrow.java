 ...
 *
 * <p>This arrow style is commonly used to indicate a generalization relationship (inheritance)
 * between two classes. The arrowhead is represented as a hollow triangle.
 */
public class GeneralizationArrow implements ArrowStrategy {
   ...
   *
   * <p>The arrow consists of a triangle-shaped arrowhead, filled with gray color, and outlined in
   * white, and a white line representing the shaft of the arrow.
   *
