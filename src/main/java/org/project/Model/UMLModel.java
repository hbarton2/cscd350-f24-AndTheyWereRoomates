...
public class UMLModel {
  ...
  public static class Class {
    ...
    /**
     * Adds a relationship between the source and destination classes. //* @param source - The
     * source class //* @param dest - The destination class.
     *
    ...
    public boolean addRelation(final String source, final String dest, final String type) {
      if (source == null || source.isEmpty()) {
        throw new IllegalArgumentException("Invalid source, try again");
      }
      if (dest == null || dest.isEmpty()) {
        throw new IllegalArgumentException("Invalid destination, try again");
      }
  ...
  public static class Storage {
    ...
    public boolean renameClass(final String oldName, final String newName)
      ...
      if (newName == null || newName.isEmpty()) {
        throw new IllegalArgumentException("Invalid new name, try again");
      }
  ...
  public static class Load {
    ...
    public boolean load(final String filePath) { // Updated method name here
      if (filePath == null) {
