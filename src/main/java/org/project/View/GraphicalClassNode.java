...
public class GraphicalClassNode extends VBox {
   ...
   */
  public GraphicalClassNode(String className) {
    ...
    this.setStyle("-fx-border-width: 5; -fx-border-color: GRAY; -fx-background-color: WHITE;");
  ...
  /**
   * Adds a method to the lists of methods in the GraphicalClassNode.
   *
